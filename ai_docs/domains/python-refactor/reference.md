...
<!-- purpose: Domain reference — 105-tool catalog, bounded profiles, workflows, key models for python-refactor-mcp. -->
...
|---|---:|---|
| `refactoring` (default) | 72 | Every mutating tool plus the inspection, preview, diagnostics, history, and recovery tools needed for safe changes |
