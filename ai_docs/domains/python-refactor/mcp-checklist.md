...
Moved to `tool-prompt-bank/README.md` — a Goal / Validation / Chaining triple for every tool on the server, split into three category files.
Kept out of this file so the checklist stays under the reference size cap.
